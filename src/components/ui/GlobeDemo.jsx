...
// ✅ Lazy load World agar WebGL canvas tidak blocking render utama
const World = lazy(() =>
  import("./globe.jsx").then((mod) => ({ default: mod.World }))
);

// ─────────────────────────────────────────────────────────────────────────────
// ✅ KRITIS: sampleArcs dan colors HARUS di luar komponen!
// ─────────────────────────────────────────────────────────────────────────────

const colors = ["#06b6d4", "#3b82f6", "#6366f1"];

// ✅ Gunakan colors.length (bukan colors.length - 1) agar index tidak pernah undefined
